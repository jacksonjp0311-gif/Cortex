# Archived README — September 6, 2026

Historical reference, not current instructions. Preserved from `ad29b81`.
Current navigation: [Cortex](README.md) · [Status](docs/STATUS.md) · [System map](docs/SYSTEM_MAP.md).
All original sections and relative asset links follow unchanged.

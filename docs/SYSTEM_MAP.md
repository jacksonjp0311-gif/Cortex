...
| Host authority | [native_agent.py](../cortex/native_agent.py)<br/>[autonomous_improvement.py](../cortex/autonomous_improvement.py)<br/>[self_improvement.py](../cortex/self_improvement.py) | [TOPOLOGY_LAW.md](../docs/intelligence/TOPOLOGY_LAW.md)<br/>[GSI-II](research/GSI_II_CUMULATIVE_GOVERNED_SELF_IMPROVEMENT_2026-09-07.md)<br/>[GSI-II.1](research/GSI_II1_CUMULATIVE_LOOP_CLOSURE_2026-09-07.md) | [test_v100_native_agent.py](../tests/test_v100_native_agent.py)<br/>[test_gsi_ii.py](../tests/test_gsi_ii.py)<br/>[test_gsi_ii1.py](../tests/test_gsi_ii1.py) | Deterministic two-generation mechanics only | MECHANISM TESTED; HOST CONTROL |
...
CURRENT: GSI-II.1 two-generation mechanics in deterministic controls; production unused.

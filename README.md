...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-7.0.0-0ea5e9?style=for-the-badge" alt="v7.0.0" />
...
**Current release: v7.0.0** — **Resonant Continuity**: body epochs, legal runtime phases, epoch-bound capabilities, five-plane continuity composition. Seals of v6.25.1 preserved. See [`docs/intelligence/PHASE_V7.0_RESONANT_CONTINUITY.md`](docs/intelligence/PHASE_V7.0_RESONANT_CONTINUITY.md).

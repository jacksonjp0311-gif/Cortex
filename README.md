...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-6.9.2-0ea5e9?style=for-the-badge" alt="v6.9.2" />
...
**Current release: v6.9.2** — Core pack **v1.2** grown (evidence, falsify, sparse, abstain, enter-exit-seal) + glyph **❖** taught intelligence + `grow_seal` phrase. See [`docs/intelligence/PACKS.md`](docs/intelligence/PACKS.md).

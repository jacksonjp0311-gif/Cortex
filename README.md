...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-6.6.0-0ea5e9?style=for-the-badge" alt="v6.6.0" />
...
**Current release: v6.6.0** — **Glyph Canon ◈** (ARIA meta medium, token thrift) + **signal loop ⟲** (`evolve`: probe→outcome→ranker/plasticity→probe→causal). See [`docs/intelligence/GLYPH_CANON.md`](docs/intelligence/GLYPH_CANON.md).

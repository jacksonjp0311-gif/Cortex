...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-6.23.0-0ea5e9?style=for-the-badge" alt="v6.23.0" />
...
**Current release: v6.23.0** — **Foreign Emergence**: thicken foreign/cold host phase (fuse + ranker warm) toward emergent coupling without identity merge. See [`docs/intelligence/PHASE_V6.23_FOREIGN_EMERGENCE.md`](docs/intelligence/PHASE_V6.23_FOREIGN_EMERGENCE.md).

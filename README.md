...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-6.5.2-0ea5e9?style=for-the-badge" alt="v6.5.2" />
...
**Current release: v6.5.2** — ops durability: mirror no longer rebinds host `.cortex` to temp homes; phase-labeled mirror reports; post-mirror re-verify; stable `CORTEX_HOME` bind. Built on 6.5.1 proof ranking + causal probe. See [`OPERATOR.md`](OPERATOR.md).

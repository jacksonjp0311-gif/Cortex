...
def _parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--fresh-model", default="mistral:latest")
    parser.add_argument("--fresh-model-version", default="undeclared")
    parser.add_argument("--fresh-model-family", default="mistral")

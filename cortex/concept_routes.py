...
CONCEPT_ROUTES: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "phrases": (
            ...
            "assembles the weighted undirected adjacency",
            "weighted undirected adjacency",
            "undirected adjacency from synapse",
            "synapse mass for spectral",
            "from synapse mass",
            "operator a",
            "a_ij",
    ...
    },
    {
        ...
        "phrases": (
            ...
            "role coherence and ranker",
            "ranker trains without merging",
            "run_host_mesh",
            "one body, many hosts",
            "one body many hosts",
        ),

...
CORE_CUES: tuple[dict[str, str], ...] = (
    ...
    {"phrase": "glyph canon", "purpose": "symbolic"},
    {"phrase": "signal loop", "purpose": "continuity"},
    {"phrase": "close the loop", "purpose": "continuity"},
    {"phrase": "meta medium", "purpose": "symbolic"},
    {"phrase": "consciousness stream", "purpose": "continuity"},
    {"phrase": "stream of consciousness", "purpose": "continuity"},
    {"phrase": "session bond", "purpose": "continuity"},
    {"phrase": "durable stream", "purpose": "continuity"},
    {"phrase": "binary intel pack", "purpose": "symbolic"},
    {"phrase": "domain zero-in", "purpose": "symbolic"},
    {"phrase": "intelligence pack", "purpose": "symbolic"},
    {"phrase": "geometry domain", "purpose": "symbolic"},
